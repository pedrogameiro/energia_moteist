...
/* {{{ LICENSE
  ...
  *	pins_energia.h
  *
  *	    Energia core files for MSP430F5438 MoteIST++s5 1011
  *
...
/* {{{ MSP430F5438a MoteIST++ pin mapping
 ...
 CB1_UCAO(RXD/SOMI)|11  12|CB1_VREGEN_ACKL
 CB1_UCAO(TXD/SIMO)|13  14|CB1_ADC12CLK/DMAE0
...
const uint8_t digital_pin_to_port[] = {
	NOT_A_PIN,   /* dummy */
	NOT_A_PIN,   /* 1 RST_NMI_SBWTDOI */ // CBC_1
	P2,          /* 2 */
	P4,          /* 3 */
	P2,          /* 4 */
	P4,          /* 5 */
